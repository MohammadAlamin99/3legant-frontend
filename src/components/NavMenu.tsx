...
export default function NavMenu() {
    return (
        <div>
            <div className="container bg-white mx-auto py-[18px] flex justify-between">
                <div>
                   <Menu size={18} color="#141718" strokeWidth={2} />
                ...
                <div className="flex items-center gap-4">
                    <Search size={26} color="#141718" strokeWidth={1.5} />
                    <CircleUser size={24} color="#141718" strokeWidth={1.5} />
